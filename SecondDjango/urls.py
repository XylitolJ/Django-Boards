...
urlpatterns = [
    ...
    re_path(r'^login/$', auth_views.LoginView.as_view(template_name='boards/login.html'), name='login'),
    ...
    re_path(r'^settings/password/$', auth_views.PasswordChangeView.as_view(template_name='boards/password_change.html'),
